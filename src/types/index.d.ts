...
export declare type IAppOptions = Record<string, any>
...
export declare interface IBitrixBase {
	BX24: BX24
...
export declare interface IBitrixBatch {
	batch(request: BatchRequestType): Promise<any>
}

export declare interface IBitrixWrapper extends IBitrixBase {
...
export declare function initBX24(): Promise<BX24>
